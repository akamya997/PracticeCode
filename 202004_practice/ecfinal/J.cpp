...
int main()
{
    ...
    {
        cin>>n>>c;
        vi p(n+1),pos(n+1),lcnt(n+1),rcnt(n+1),fac(n+1);
        ll ans=1;
        for(int i=1;i<=n;i++)
        {
            cin>>p[i];
        ...
        for(int i=1;i<=n;i++)
        {
            ...
            if(!l||!r||l&&r&&l+rcnt[l]*c<r-lcnt[r]*c)
            {
                if(l+rcnt[l]*c<pos[i]) l=0;
                if(r-lcnt[r]*c>pos[i]) r=0;
            }
            if(!l&&!r)
            {
                lcnt[pos[i]]++;
            ...
            {
                if(l+rcnt[l]*c<n) ans=ans*(min((ll)n-l,rcnt[l]*c)-rcnt[l]+1)%mod;
                else if(l+c<=n){
                    fac[l]++;
                    ans=ans*fac[l]%mod;
                }
                ...
                if(r-lcnt[r]*c>1) ans=ans*(min((ll)r-1,lcnt[r]*c)-lcnt[r]+1)%mod;
                else if(r>c){
                    fac[l]++;
                    ans=ans*fac[l]%mod;
                }
